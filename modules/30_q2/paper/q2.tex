...
指标 & 附件基准 & SFETA 方案 & 变化 \\
\midrule
运行成本 / CNY & 1,801,786,872.69 & 1,669,594,049.27 & $-132,192,823.42$（$-7.34\%$）\\
碳排放 / tCO\textsubscript{2} & 2,045,367.48 & 1,918,213.49 & $-127,153.98$（$-6.22\%$）\\
新能源利用率 & 32.85\% & 36.30\% & $+3.45$ 个百分点 \\
...
50000 个任务全部成功调度，其中跨区域迁移 23329 个（迁移率 46.66\%），延迟开工 21158 个。按任务类型统计：AITraining 迁移 12089/16559 个，BatchInference 迁移 11240/16717 个，RealTimeInference 保持来源区域即时开工。平均网络时延 26.22 ms，95\% 分位 79 ms，最大 82 ms，全部满足 SLA 要求。平均等待 15.28 h，95\% 分位 45 h。
...
\end{equation}
其中上界来自连续松弛下的 removal-side 分析。当前方案中，成本柔性捕获率约 38.62\%，碳柔性捕获率约 42.06\%，说明 SFETA 方案已获取附件中相当比例的可用计算柔性，同时保留了从松弛上界到实际可执行调度之间的提升空间。
